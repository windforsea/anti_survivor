...
export const HERO_CONFIGS = {
  ...
  sylph: { id: 'sylph', name: '바람의 궁수 (Sylph)', role: 'WIND SNIPER', hp: 90, speed: 240, projSpeedBonus: 0.30, areaBonus: 0.25, startWeapon: 'windBow', desc: '초장거리 돌풍 화살로 다가오는 적들을 꿰뚫고 밀어내는 명사수' },
  malakar: { id: 'malakar', name: '심연의 워록 (Malakar)', role: 'DARK DRAIN', hp: 110, speed: 220, atkBonus: 0.15, vampireChance: 0.03, startWeapon: 'shadowOrb', desc: '적의 생명력을 흡수하고 피격 시 암흑 충격파로 반격하는 흑마도사' }
};
