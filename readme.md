...
│   ├── 📄 enemies.md          # 15종 일반 몬스터, 10종 보스 기믹 및 패턴(진 붉은 사신)
│   ├── 📄 stages.md           # 20스테이지 웨이브 타임라인, 사신 강림, 부유섬 전장 규칙
...
│   ├── 📄 enemies.js          # Enemy, BossEnemy: 15종 일반 몹 AI & 10종 보스 기믹(공허의 지네, 혼돈의 절대신, 진 붉은 사신)
