...
- **12종 기본 무기 & 12대 2단계 특수 합성 진화**: 무기 5레벨 달성 시 직관적인 2단계 메커니즘의 강력한 진화 무기로 합성 (생츄어리, 블리자드, 뇌전포, 벼락검, 화염도끼, 역병 등 12종).
...
| 🗡️ **무기 및 진화 체계** | 12종 기본 무기 스펙, 4대 강화 옵션, 12대 진화 무기 조합 공식 | [docs/weapons.md](docs/weapons.md) |
