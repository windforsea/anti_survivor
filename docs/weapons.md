...
| **학살자의 폭풍검 (`slayerBladeStorm`)** | **근접** | [`slayerBladeStorm.js`](file:///g:/내%20드라이브/vam/js/weapons/evolutions/slayerBladeStorm.js) | **철검(5Lv) + 도끼(5Lv)** | 56 | 0.50s (회전무기 4개) | 거대 대검과 도끼들이 플레이어 주위를 초고속 상시 궤도 회전하며 접근하는 모든 적을 갈아내고 강력한 넉백(240) 부여 |
